    ...
    const certifications = [
        {
            ...
            certificate: 'certificates/avodhaEHC.png',
            description: 'successfully completed Avoha Ethical Hacking course',
            pdf: '/pdf/AvodhaECH.pdf'
        }, {
            title: 'CyberSecurity ',
            certificate: 'certificates/tcsCAE.png',
            description: 'successfully completed TCS Cybersecurity Analyst Job Simulation',
            pdf: ''
        }, {
            title: 'Postman',
            certificate: 'certificates/LUEJS.png',
            description: 'successfully completed java script bootcamp from Lets Upgrade',
            pdf: 'certificates/LUEJS.png'
        }
    ]
